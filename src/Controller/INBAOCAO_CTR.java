		...
		if(id!=null)
		{
			...
			case 1:
				...
				if(MaDH!=null)//Neu ma DH khac NULL co nghia la nguoi dung da nhan in don hang
				{
					...
					Indondathang(MaDH,response,request,k.getConnection(),nv);//Goi ham in don hang
				}
				else
				{
			...
			case 2:
				...
				{
					InTOP10SP(thang,nam,response,request,k.getConnection(),nv);
				}
				else
				{
			...
			case 3:
				...
				{
					ThongkedoanhthutheoNgay(tungay,denngay,response,request,k.getConnection(),nv);
				}
				else
				{
			...
			case 4:
				...
				if(th!=null&&na!=null)
				{
					ThongkedoanhthutheoThang(th,na,response,request,k.getConnection(),nv);
				}
				else
				{
				...
				break;
			case 5:
				Thongkehangton(response,request,k.getConnection(),nv);
				break;
			...
			case 6:
				...
				if(mahd!=null)
				{
					Laphoadon(mahd,response,request,k.getConnection(),nv);
				}
				else
				{
				...
				break;
			case 7:
				Thongkeloaikhachhang(response,request,k.getConnection());
				break;
			}	
		}
	}
